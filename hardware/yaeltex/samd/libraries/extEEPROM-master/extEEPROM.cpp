...
#define BUFFER_LENGTH WIRE_BUFFER_READ_SIZE
// Constructor.
...
byte extEEPROM::begin(twiClockFreq_t twiReadFreq, twiClockFreq_t twiWriteFreq)
{
    readFreq = twiReadFreq;
    writeFreq = twiWriteFreq;

    Wire.begin();
    //TWBR = ( (F_CPU / twiFreq) - 16) / 2;
                                  // Start Wire (I2C)
    setWireFreq(writeFreq);
...
void extEEPROM::setWireFreq(twiClockFreq_t newFreq){
    sercom3.disableWIRE();                         // Disable the I2C bus
    SERCOM3->I2CM.BAUD.bit.BAUD = SystemCoreClock / ( 2 * newFreq) - 1 ;   // // Set the I2C SCL frequency to 400kHz
    sercom3.enableWIRE();    
}
...
/////////////////////////////////////////////////////////////////////////////////////////
// YAELTEX MODIFIED READ FUNCTION - Franco Grassano / Franco Zaccra
// Also modified Wire.requestFrom() to store incoming bytes in "values"
/////////////////////////////////////////////////////////////////////////////////////////    
    setWireFreq(readFreq);
    ...
    Wire.requestFrom(ctrlByte, nBytes, values);
/////////////////////////////////////////////////////////////////////////////////////////
