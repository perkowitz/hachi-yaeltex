...
class extEEPROM
{
    public:
        ...
        enum twiClockFreq_t { twiClock100kHz = 100000, 
                              twiClock400kHz = 400000, 
                              twiClock600kHz = 600000, 
                              twiClock800kHz = 800000, 
                              twiClock1000kHz = 1000000 };
                              
        extEEPROM(eeprom_size_t deviceCapacity, byte nDevice, unsigned int pageSize, byte eepromAddr = 0x50);
        byte begin(twiClockFreq_t twiReadFreq = twiClock400kHz, twiClockFreq_t twiWriteFreq = twiClock400kHz);
        ...
        void setWireFreq(twiClockFreq_t newFreq);

    private:
        twiClockFreq_t readFreq;
        twiClockFreq_t writeFreq;
