...
// 2 quake, 4 flow
static module_type moduleConfig[MODULE_COUNT] = { QUAKE, QUAKE, FLOW, FLOW, FLOW, FLOW, BLANK, BREATH };
static u8 moduleColor[MODULE_COUNT] = { BRT_RED, BRT_RED, BRT_GREEN, BRT_GREEN, BRT_GREEN, BRT_GREEN, ABS_BLACK, WHITE };
static u8 moduleDimColor[MODULE_COUNT] = { DIM_RED, DIM_RED, DIM_GREEN, DIM_GREEN, DIM_GREEN, DIM_GREEN, ABS_BLACK, WHITE };
