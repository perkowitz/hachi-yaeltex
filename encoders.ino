...
//////            encoderValue[encNo] += encoderPosition[encNo];
////            if(++pulseCounter == 2){            // if movement is slow, count to four, then add
////              encoderValue[encNo] += encoderPosition[encNo];
////              pulseCounter = 0;
////            }
////          }else if(++pulseCounter == 4){            // if movement is slow, count to four, then add
////            encoderValue[encNo] += encoderPosition[encNo];
////            pulseCounter = 0;
////          }
//          SerialUSB.print("Encoder ");SerialUSB.print(encNo);SerialUSB.print(" value: ");
//          SerialUSB.println(encoderValue[encNo]);
...
//            }
////            SerialUSB.print("Encoder N° "); SerialUSB.println(encNo);
