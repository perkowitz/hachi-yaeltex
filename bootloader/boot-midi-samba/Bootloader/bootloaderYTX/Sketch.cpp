...
uint8_t R[5] = {200,	0,		120,	0,		200};
uint8_t G[5] = {120,	200,	0,		120,	200};
uint8_t B[5] = {120,	0,		120,	200,	0};
...
//
	...
	uint32_t sampleRate = 10; //sample rate in milliseconds, determines how often TC5_Handler is called
